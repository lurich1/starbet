-- ============================================================================
-- Star Bet — full database setup (single file)
-- schema.sql followed by every migration in order (0001 .. 0014).
-- Idempotent: safe to run top-to-bottom on a fresh Supabase project,
-- and re-runnable (uses IF NOT EXISTS / ADD COLUMN IF NOT EXISTS).
-- ============================================================================
...
-- ==================== migrations/0013_tower_rush.sql ====================
-- ============================================================================
